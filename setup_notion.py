...
def create_database(parent_page_id: str):
    ...
    try:
        ...
        print(f"\n=========================================")
        print(f"[EXITO] BASE DE DATOS CREADA EN NOTION CON EXITO!")
        print(f"=========================================")
        ...
        print(f"[Error] Fallo la creacion de la base de datos: {e}")
...
def main():
    print("=========================================")
    print("CONFIGURADOR AUTOMATICO DE NOTION")
    print("=========================================\n")
    ...
    print("[Notion] Buscando paginas que compartiste con el bot...")
    pages = search_shared_pages()
    
    if not pages:
        print("\n[NOTION] No se encontraron paginas compartidas!")
        print("----------------------------------------------------------------")
        print("Instrucciones de configuracion obligatorias:")
        print("1. Abre tu espacio de trabajo de Notion en el navegador.")
        print("2. Ve a la pagina (o crea una nueva) donde quieres crear la base de datos.")
        ...
        print("5. Busca y selecciona tu bot/integracion con el token proporcionado.")
    ...
    parent_title = "Pagina de Notion"
    try:
        parent_title = parent_page.get("properties", {}).get("title", {}).get("title", [{}])[0].get("text", {}).get("content", "Pagina de Notion")
    except Exception:
        pass
        
    print(f"[Notion] Encontrada pagina compartida: '{parent_title}' (ID: {parent_id})")
    ...
    if db_id:
        ...
        print("[CONFIG] Configuracion completada con exito! Notion ahora esta en MODO REAL.")
    else:
        print("[ERROR] Fallo la configuracion de la base de datos.")
